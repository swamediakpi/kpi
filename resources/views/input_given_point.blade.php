...
<div class="" role="tabpanel" data-example-id="togglable-tabs">
  ...
  <div class="x_panel">
    ...
    <div class="form-horizontal form-label-left">                
      ...
      <div class="form-group">
        <label class="control-label col-md-1 col-sm-3 col-xs-12">BOBOT</label>
        <div class="col-md-9 col-sm-9 col-xs-12">
...
$('#btn-input-given-hrd').click(function(){
    ...
    if( areakinerjahrd == "" || kpihrd == "" || bobothrd == ""){
       ...
       $.ajax({
            url : baseUrl +'/givenpointhrd/input',
            type: 'POST',
...
$('#btn-input-given-pmo').click(function(){
    ...
    if( areakinerjapmo == "" || kpipmo == "" || bobotpmo == ""){
       ...
       $.ajax({
            url : baseUrl +'/givenpointpmo/input',
            type: 'POST',
...
$('#btn-input-given-unit').click(function(){
    ...
    if( areakinerjaunit == "" || kpiunit == "" || bobotunit == ""){
      ...
      $.ajax({
            url : baseUrl +'/givenpointunit/input',
            type: 'POST',
