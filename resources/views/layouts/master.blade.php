					...
					<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								<li><a href="{{ url('/index') }}"><i class="fa fa-home"></i><span class="fa fa-chevron-down"></span> Dashboard</a>
									<ul class="nav child_menu">
										<li><a href="{{ url('/index') }}"><i class="fa fa-home"></i>Dashboard</a></li>
										<li><a href="#"><i class="fa fa-home"></i>Dashboard Cube </a></li>
								...
								<li><a href="#"><i class="fa fa-edit"></i> Edit <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a>Days Project Emp Live<span class="fa fa-chevron-down"></span></a>
											<ul class="nav child_menu">
												<li><a href="{{ url('/edit_days_project') }}">Forget</a></li>
												<li><a href="{{ url('/edit_days_project_touch') }}">Touched</a></li>
											</ul>
										</li>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="">
								...
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a href="" data-toggle="modal" data-target="#modalphoto"><i class="fa fa-cog pull-right"></i>Change Photo</a></li>
									<li>
